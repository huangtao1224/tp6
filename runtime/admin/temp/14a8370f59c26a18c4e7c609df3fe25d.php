<?php /*a:3:{s:56:"D:\phpstudy_pro\WWW\tp\app\admin\view\content\index.html";i:1655709032;s:54:"D:\phpstudy_pro\WWW\tp\app\admin\view\Common\head.html";i:1655533487;s:54:"D:\phpstudy_pro\WWW\tp\app\admin\view\Common\foot.html";i:1649475024;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-card-body layui-table-body">
            <form class="layui-form">
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="checkbox" lay-filter="child" lay-skin="primary" title="<?php echo htmlentities($vo[$table_id]); ?>" value="<?php echo htmlentities($vo[$table_id]); ?>" class="child">
                        </td>
                        ...
                        <td>
                            ...
                            <button class="layui-btn-danger layui-btn layui-btn-xs layui-btn2" type="button" onclick="member_del(this,'<?php echo url('/admin/content/del_save'); ?>','<?php echo htmlentities($vo[$table_id]); ?>')"><i class="layui-icon"></i>删除</button>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                ...
                <div class="layui-form-item btn_box">
                    <?php if($functionSwitch['batch_copy']==1): ?>
