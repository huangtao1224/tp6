<?php /*a:3:{s:55:"D:\phpstudy_pro\WWW\tp\app\admin\view\content\edit.html";i:1655693062;s:54:"D:\phpstudy_pro\WWW\tp\app\admin\view\Common\head.html";i:1655533487;s:54:"D:\phpstudy_pro\WWW\tp\app\admin\view\Common\foot.html";i:1649475024;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-fluid">
        <div class="layui-row">
            <form class="layui-form" id="layui-form" enctype="multipart/form-data" method="post" action="/admin/content/edit_save">
                <input type="hidden" name="<?php echo htmlentities($table_name); ?>_id" value="<?php echo htmlentities($content_id); ?>">
                <input type="hidden" name="type_id" value="<?php echo htmlentities($content['type_id']); ?>">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="<?php echo htmlentities($vo['field_name']); ?>" name="<?php echo htmlentities($vo['field_name']); ?>" value="<?php echo htmlentities($content[$vo['field_name']]); ?>" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <?php break; case "2": ?>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <textarea name="<?php echo htmlentities($vo['field_name']); ?>" class="layui-textarea"><?php echo htmlentities($content[$vo['field_name']]); ?></textarea>
                                </div>
                            </div>
                            <?php break; case "3": ?>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    <textarea id="<?php echo htmlentities($vo['editor']); ?>" name="<?php echo htmlentities($vo['field_name']); ?>" style="width:100%;height:200px;"><?php echo htmlentities($content[$vo['field_name']]); ?></textarea>
                                </div>
                            </div>
                            <?php break; case "4": ?>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <?php if(is_array($vo['site_subclass']) || $vo['site_subclass'] instanceof \think\Collection || $vo['site_subclass'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['site_subclass'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                                    <input type="radio" name="<?php echo htmlentities($vo['field_name']); ?>" title="<?php echo htmlentities($vo2['input_name']); ?>" value="<?php echo htmlentities($vo2['input_value']); ?>" <?php echo $content[$vo['field_name']]==$vo2['input_value'] ? 'checked' : ''; ?>>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                            <?php break; case "6": ?>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="<?php echo htmlentities($vo['field_name']); ?>">
                                        ...
                                        <?php if(is_array($vo['site_subclass']) || $vo['site_subclass'] instanceof \think\Collection || $vo['site_subclass'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['site_subclass'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo htmlentities($vo2['input_value']); ?>" <?php echo $content[$vo['field_name']]==$vo2['input_value'] ? 'selected' : ''; ?>><?php echo htmlentities($vo2['input_name']); ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    <?php if(!(empty($content[$vo['field_name']]) || (($content[$vo['field_name']] instanceof \think\Collection || $content[$vo['field_name']] instanceof \think\Paginator ) && $content[$vo['field_name']]->isEmpty()))): ?>
                                    <div style="display: inline-block;">
                                       <a href="/<?php echo htmlentities($content[$vo['field_name']]); ?>"><img src="/<?php echo htmlentities($content[$vo['field_name']]); ?>" style="width: 50px;height: 30px;"></a>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <?php if(empty($content[$vo['field_name']]) || (($content[$vo['field_name']] instanceof \think\Collection || $content[$vo['field_name']] instanceof \think\Paginator ) && $content[$vo['field_name']]->isEmpty())): ?>
                                    <input name="<?php echo htmlentities($vo['field_name']); ?>" type="text" value="" autocomplete="off" class="layui-input layerdate"/><i class="bi bi-calendar3"></i>
                                    <?php else: ?>
                                    <input name="<?php echo htmlentities($vo['field_name']); ?>" type="text" value="<?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($content[$vo['field_name']])? strtotime($content[$vo['field_name']]) : $content[$vo['field_name']])); ?>" autocomplete="off" class="layui-input layerdate"/><i class="bi bi-calendar3"></i>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <?php break; case "9": ?>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <div class="layui-form-item">
                                        <div class="layui-input-inline">
                                            <input type="text" name="<?php echo htmlentities($vo['field_name']); ?>" value="<?php echo htmlentities($content[$vo['field_name']]); ?>" class="layui-input">
                                        </div>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="title" name="title" value="<?php echo htmlentities($content['title']); ?>" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="keywords" class="layui-form-label">浏览器关键词</label>
                                <div class="layui-input-inline">
                                    <input type="text" id="keywords" name="keywords" value="<?php echo htmlentities($content['keywords']); ?>" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label for="description" class="layui-form-label">浏览器描述</label>
                                <div class="layui-input-inline">
                                    <input type="text" id="description" name="description" value="<?php echo htmlentities($content['description']); ?>" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                    </div>
