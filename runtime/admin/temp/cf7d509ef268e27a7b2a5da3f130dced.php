<?php /*a:3:{s:55:"D:\phpstudy_pro\WWW\tp\app\admin\view\classify\add.html";i:1650598512;s:54:"D:\phpstudy_pro\WWW\tp\app\admin\view\Common\head.html";i:1655533487;s:54:"D:\phpstudy_pro\WWW\tp\app\admin\view\Common\foot.html";i:1649475024;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="classify_pid">
                                        ...
                                        <option value="<?php echo htmlentities($vo['classify_id']); ?>" <?php if($classify['classify_id']==$vo['classify_id']): ?> selected <?php endif; ?>><?php echo htmlentities($vo['classify_name']); ?></option>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="<?php echo htmlentities($vo['field_name']); ?>" name="<?php echo htmlentities($vo['field_name']); ?>" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <?php break; case "2": ?>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <textarea name="<?php echo htmlentities($vo['field_name']); ?>" class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <?php break; case "3": ?>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    <textarea id="<?php echo htmlentities($vo['editor']); ?>" name="<?php echo htmlentities($vo['field_name']); ?>" style="width:100%;height:200px;"></textarea>
                                </div>
                            </div>
                            <?php break; case "4": ?>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    <input type="radio" name="<?php echo htmlentities($vo['field_name']); ?>" title="<?php echo htmlentities($vo2['input_name']); ?>" value="<?php echo htmlentities($vo2['input_value']); ?>">
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                            <?php break; case "6": ?>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="<?php echo htmlentities($vo['field_name']); ?>">
                                        <?php if(is_array($vo['site_subclass']) || $vo['site_subclass'] instanceof \think\Collection || $vo['site_subclass'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['site_subclass'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo htmlentities($vo2['input_value']); ?>"><?php echo htmlentities($vo2['input_name']); ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label"><?php echo htmlentities($vo['input_name']); ?></label>
                                <div class="layui-input-inline">
                                    <input name="<?php echo htmlentities($vo['field_name']); ?>" type="text" autocomplete="off" class="layui-input layerdate"/><i class="bi bi-calendar3"></i>
                                </div>
                            </div>
                            <?php break; case "9": ?>
                            大文件
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <div class="layui-form-item">
                                        <div class="layui-input-inline">
                                            <input type="text" name="<?php echo htmlentities($vo['field_name']); ?>" class="layui-input">
                                        </div>
